...
interface ArrowPathRoundedSquareIconProps extends HTMLAttributes<SVGElement> {

}

const defaults = {}

export const ArrowPathRoundedSquareIcon = (props: ArrowPathRoundedSquareIconProps) => {
