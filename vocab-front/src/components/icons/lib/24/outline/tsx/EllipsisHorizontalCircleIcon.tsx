...
interface EllipsisHorizontalCircleIconProps extends HTMLAttributes<SVGElement> {
  'stroke-width'?: number
}

const defaults = {"stroke-width":"1.5"}

export const EllipsisHorizontalCircleIcon = (props: EllipsisHorizontalCircleIconProps) => {
