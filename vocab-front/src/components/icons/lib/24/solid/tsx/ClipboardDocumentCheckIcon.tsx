...
interface ClipboardDocumentCheckIconProps extends HTMLAttributes<SVGElement> {

}

const defaults = {}

export const ClipboardDocumentCheckIcon = (props: ClipboardDocumentCheckIconProps) => {
