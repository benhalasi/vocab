...
interface DocumentMagnifyingGlassIconProps extends HTMLAttributes<SVGElement> {

}

const defaults = {}

export const DocumentMagnifyingGlassIcon = (props: DocumentMagnifyingGlassIconProps) => {
